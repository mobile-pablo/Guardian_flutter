  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.isHosted, isHosted) ||
                other.isHosted == isHosted) &&
            (identical(other.pillarId, pillarId) ||
                other.pillarId == pillarId) &&
            (identical(other.pillarName, pillarName) ||
...
abstract class _NewsItem implements NewsItem {
  const factory _NewsItem(
      ...
      required final String webPublicationDate,
      required final String webTitle,
      required final String webUrl,
      required final String apiUrl,
      required final bool isHosted,
      required final String pillarId,
      required final String pillarName}) = _$NewsItemImpl;
