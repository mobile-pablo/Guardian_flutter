...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i8.HomeScreen>(
      () => _i8.HomeScreen(key: gh<_i9.Key>()),
      registerFor: <String>{
        _prod,
        _dev,
        _test,
    ...
    gh.factory<_i10.MyApp>(
      () => _i10.MyApp(key: gh<_i11.Key>()),
      registerFor: <String>{
        _prod,
        _dev,
      },
    );
    gh.factory<_i12.NewsDao>(
      () => _i13.NewsDaoImpl(gh<_i3.AppDatabase>()),
      registerFor: <String>{
        _prod,
        _dev,
      },
