...
import 'package:flutter_drift_1/domain/repository/news_repository_impl.dart'
    as _i16;
import 'package:flutter_drift_1/domain/use_cases/get_news_use_case.dart' as _i5;
...
import 'package:flutter_drift_1/feature/home/bloc/remote/home_remote_bloc.dart'
    as _i9;
import 'package:flutter_drift_1/feature/home/page/home_screen.dart' as _i10;
import 'package:flutter_drift_1/main.dart' as _i13;
import 'package:flutter_drift_1/networking/service/guardian_service.dart'
    as _i7;
import 'package:flutter_drift_1/storage/dao/news_dao.dart' as _i17;
import 'package:flutter_drift_1/storage/dao/news_dao_impl.dart' as _i15;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i5.GetNewsUseCase>(
        () => _i5.GetNewsUseCase(gh<_i16.NewsRepositoryImpl>()));
    gh.factory<_i7.GuardianService>(() => _i7.GuardianService(gh<_i8.Dio>()));
    gh.factory<_i9.HomeRemoteBloc>(
        () => _i9.HomeRemoteBloc(gh<_i5.GetNewsUseCase>()));
    gh.factory<_i10.HomeScreen>(() => _i10.HomeScreen(key: gh<_i11.Key>()));
    gh.factory<_i12.InsertNewsItemUseCase>(
        () => _i12.InsertNewsItemUseCase(gh<_i16.NewsRepositoryImpl>()));
    gh.factory<_i13.MyApp>(() => _i13.MyApp(key: gh<_i14.Key>()));
    gh.factory<_i15.NewsDaoImpl>(() => _i15.NewsDaoImpl(gh<_i3.AppDatabase>()));
    gh.factory<_i16.NewsRepositoryImpl>(() => _i16.NewsRepositoryImpl(
          gh<_i7.GuardianService>(),
          gh<_i17.NewsDao>(),
        ));
    gh.factory<_i18.RemoveNewsItemUseCase>(
        () => _i18.RemoveNewsItemUseCase(gh<_i16.NewsRepositoryImpl>()));
    gh.factory<_i19.UpdateNewsItemUseCase>(
        () => _i19.UpdateNewsItemUseCase(gh<_i16.NewsRepositoryImpl>()));
    gh.factory<_i20.HomeLocalBloc>(() => _i20.HomeLocalBloc(
          gh<_i12.InsertNewsItemUseCase>(),
